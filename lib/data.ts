...
I want to build out a proper web UI with search, library management, and playback controls. Desktop app support using Electron or Wails is also planned. Longer term, I'd like to experiment with more advanced piece selection algorithms, add support for magnet links with metadata exchange, and implement bandwidth throttling controls for users on limited connections.`,
  ...
  },
  {
    id: "yonder",
    title: "Yonder",
    description: "University Rover Challenge work — navigation, cameras, and control systems.",
    longDescription: `Yonder is the rover software and tooling developed for the University Rover Challenge. The project includes navigation, camera integration, and operator tooling to support autonomous mission workflows.`,
    image: "/assets/yonder.png",
    status: "In Progress",
    progress: 70,
    startDate: "2024-10-01",
    categories: ["Robotics", "ROS", "Navigation"],
    tools: ["ROS", "Python", "RViz", "Gazebo"],
    githubUrl: undefined,
    liveUrl: undefined,
    takeaways: [
      "Integrated ROS stacks with non-ROS camera feeds for unified operator views",
      "Implemented navigation and path-tracking tools for autonomous missions",
    ],
  },
  {
